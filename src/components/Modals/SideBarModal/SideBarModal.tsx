            ...
            <div className={styles.side_bar}>
                ...
                <nav className={styles.side_bar__nav}>
                    ...
                    <NavLink onClick={onLinkClick} to={"/collpoints"} className={styles.side_bar__nav__link}>Пункты
                        сбора</NavLink>
                    <NavLink onClick={onLinkClick} to={"/ecomarket"}
                             className={styles.side_bar__nav__link}>ЭкоМаркет</NavLink>
                    <NavLink onClick={onLinkClick} to={"/aboutservice"} className={styles.side_bar__nav__link}>О
                        сервисе</NavLink>
                </nav>
